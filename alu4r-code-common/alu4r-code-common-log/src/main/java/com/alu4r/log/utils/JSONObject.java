...
public class JSONObject extends LinkedHashMap<String, Object>
{
    ...
    public JSONObject(final com.alu4r.log.utils.JSONObject other)
    {
        super(other);
    }
     ...
     * @return 返回本对象。
     */
    public com.alu4r.log.utils.JSONObject value(final String name, final Object value)
    {
        final int indexDot = name.indexOf('.');
        if (indexDot >= 0)
        {
     ...
     */
    public com.alu4r.log.utils.JSONObject obj(final String name)
    {
        final Matcher matcher = arrayNamePattern.matcher(name);
        if (matcher.find())
        {
            return endArray(matcher.group(1), matcher.group(2), new EndArrayCallback<com.alu4r.log.utils.JSONObject>()
            {
                @Override
                public com.alu4r.log.utils.JSONObject callback(JSONArray arr, int index)
                {
        ...
        {
            com.alu4r.log.utils.JSONObject obj = getObj(name);
            if (obj == null)
            {
                obj = new com.alu4r.log.utils.JSONObject();
                put(name, obj);
            }
            return obj;
        }
     ...
     * @return 返回指定的对象字段。
     */
    public com.alu4r.log.utils.JSONObject getObj(final String name)
    {
        return (com.alu4r.log.utils.JSONObject) get(name);
    }
     ...
     * @return 返回本对象
     */
    public com.alu4r.log.utils.JSONObject set(final String name, final Object value)
    {
        put(name, value);
        return this;
    }
    ...
    {
        if (!(value instanceof com.alu4r.log.utils.JSONObject) && value instanceof Map)
        {
    ...
    private static com.alu4r.log.utils.JSONObject toObj(final Map<String, Object> map)
    {
        final com.alu4r.log.utils.JSONObject obj = new com.alu4r.log.utils.JSONObject();
     ...
     */
    private static com.alu4r.log.utils.JSONObject objAt(final JSONArray arr, int index)
    {
        expand(arr, index);
        if (arr.get(index) == null)
        {
            arr.set(index, new com.alu4r.log.utils.JSONObject());
        }
        return (com.alu4r.log.utils.JSONObject) arr.get(index);
    }
